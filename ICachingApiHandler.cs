...
namespace Tidy.AdventOfCode
{
    ...
    {
        /// <summary>
        /// Get the input string value for the given <paramref name="year"/> and <paramref name="day"/> from the server. Note that input does not vary between the two parts of a riddle. If the input was already obtained, it will be returned from local file cache.
        /// </summary>
        ...
        Task<string> GetInputAsync(int year, int day, CancellationToken cancellationToken = default);
